...
vi.mock("../src/web3/journeyman.js", () => ({ getPublicClient: () => ({ readContract }) }));
vi.mock("../src/config.js", () => ({
  config: { journeymanAddress: "0x00000000000000000000000000000000000A7E11", applicationWindowMinutes: 3 },
}));
