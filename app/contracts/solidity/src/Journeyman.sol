...
import "./yield/IJourneymanYield.sol";
 ...
 *
 * WHAT THAT COSTS, STATED PLAINLY. Journeyman's promise is that neither party
 ...
 *   5. Run the upgrade tests in test/JourneymanUpgrade.t.sol before shipping.
 */
/*
 * ─────────────────────────────────────────────────────────────────────────────
 ...
 * JourneymanYield, reached through a single controller pointer, and the split is
    ...
    UUPSUpgradeable
{
     ...
     * existed.
     *
     * (It is also what brought Journeyman back under EIP-170. Combined, the two
     ...
     */
    IJourneymanYield public yieldController;
    ...
    function setYieldController(address controller) external onlyOwner {
        yieldController = IJourneymanYield(controller);
    }
