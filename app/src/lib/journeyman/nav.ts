/**
 * JOURNEYMAN — the information architecture, as data.
 *
 ...
 *
 * Journeyman's original routes still resolve — see the redirects in App.tsx —
...
/**
 * Journeyman's original paths, kept alive.
 *
