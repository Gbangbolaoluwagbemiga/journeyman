...
import { forgetWorker, linkOwnWallet, type Worker } from "@/lib/journeyman/worker";
            ...
            <p className="text-[11px] text-muted-foreground leading-relaxed">
              {connectedAddress ? (
                <>
                  ...
                  , and anything in this wallet is sent there first. Journeyman
                  stops signing for you — you sign for yourself from then on.
                </>
              ) : (
                <>
                  Connect the wallet you want to use first. Your history and
                  your balance follow it, and Journeyman stops holding keys for
                  you.
                </>
              )}
            </p>
