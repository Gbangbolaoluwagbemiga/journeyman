...
import { fetchMyApplications, type AppliedJob, type ApplicationOutcome } from "@/lib/journeyman/applications";
import { categoryLabel, withoutMarker } from "@/lib/journeyman/categories";
